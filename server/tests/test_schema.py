...
# ============================================================================
# NetworkRule Validation Tests
# ============================================================================


class TestNetworkRuleValidation:
    """Tests for Literal['allow', 'deny'] constraint on NetworkRule."""
    ...
    def test_invalid_action_raises(self):
        with pytest.raises(ValidationError):
            NetworkRule(action="block", target="x.com")

    def test_empty_action_raises(self):
        with pytest.raises(ValidationError):
            NetworkRule(action="", target="x.com")

    def test_target_required(self):
        with pytest.raises(ValidationError):
            NetworkRule(action="allow")  # type: ignore
...
class TestNetworkPolicyValidation:
    """Tests for Literal['allow', 'deny'] constraint on NetworkPolicy."""

    def test_valid_default_action_allow(self):
        policy = NetworkPolicy(default_action="allow")
        assert policy.default_action == "allow"

    def test_valid_default_action_deny(self):
        policy = NetworkPolicy(default_action="deny")
        assert policy.default_action == "deny"

    def test_invalid_default_action_raises(self):
        with pytest.raises(ValidationError):
            NetworkPolicy(default_action="block")

    def test_default_action_none_allowed(self):
        policy = NetworkPolicy()
        assert policy.default_action is None
