...
def create_workload_provider(
    ...
    if provider_type_lower == PROVIDER_TYPE_BATCHSANDBOX:
        ...
        return provider_class(
            ...
            storage_size=k8s_config.storage_size,
            snapshot_enabled=k8s_config.snapshot_enabled,
            snapshot_class=k8s_config.snapshot_class,
            snapshot_max_retention=k8s_config.snapshot_max_retention,
            archive_after_seconds=k8s_config.archive_after_seconds,
            filesystem_persistence=k8s_config.filesystem_persistence,
            sandbox_user=k8s_config.sandbox_user,
