...
type BatchSandboxSpec struct {
	...
	// ExpireTime - Absolute time when the batch-sandbox is paused (or deleted for pool-based sandboxes).
	// If a time in the past is provided, the batch-sandbox will be paused immediately.
	// +optional
